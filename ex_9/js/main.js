...
// Y-Axis label
yAxis.append("text").attr("class", "axis-title").attr("transform", "rotate(-90)").attr("y", 6).attr("dy", ".71em").style("text-anchor", "end").attr("fill", "#5D6971").text("Population)");
...
d3.json("https://raw.githubusercontent.com/gcastillo56/d3Lab/master/charts/line_chart/data/example.json").then((data) => {
  ...
  // Add line to chart
  g.append("path").attr("class", "line").attr("fill", "none").attr("stroke", "grey").attr("stroke-with", "3px").attr("d", line(data));
