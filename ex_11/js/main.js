...
// Y-Axis label
yAxis.append("text").attr("class", "axis-title").attr("fill", "#000").attr("transform", "rotate(-90)").attr("y", 6).attr("dy", "0.71em").attr("text-anchor", "end").text("Billions of liters");

// Legend code
var legend = g.append("g").attr("transform", "translate(" + (width + 150) + "," + (height - 210) + ")");

d3.csv("https://raw.githubusercontent.com/gcastillo56/d3Lab/master/charts/stacked_chart/data/stacked_area2.csv")
  .then((data) => {
    color.domain(
